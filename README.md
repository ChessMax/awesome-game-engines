...
The list of **88** awesome game engines, game frameworks that you might be used to implement cool
and awesome games.
...
- [Codename One](https://github.com/codenameone/CodenameOne) - Cross-platform Java framework with beta game APIs and a visual Game Builder for 2D and 3D games.
- [Comet Engine](https://www.cometengine.org/) - 2D cross-platform (windows, linux, android and web) game engine with all 2D basics and much more as lights, shadows, navigation... with [AngelScript](https://github.com/anjo76/angelscript) (C#-like) for the scripting system.
...
- [Dagor](https://github.com/GaijinEntertainment/DagorEngine) - Formerly closed source 3D game engine made and mostly used by Gajin Entertainment.
...
- [HaxePunk](https://github.com/HaxePunk/HaxePunk) - Cross-platform desktop, mobile, and WebGL game engine, based on FlashPunk.
- [Hazel Engine](https://github.com/TheCherno/Hazel) - Hazel is primarily an early-stage interactive application and rendering engine for Windows. Currently not much is implemented, however (almost) everything inside this repository is being created within YouTube videos.
...
- [Lina Engine](https://github.com/inanevin/LinaEngine) - Lina Engine is an open-source , modular, tiny and fast C++ game engine, aimed to develop 3D desktop games.
...
# U (5):
- [U3D](https://github.com/u3d-community/U3D) - U3D is a open source, lightweight, cross-platform 2D and 3D game engine implemented in C++. Forked from Urho3D and greatly inspired by OGRE and Horde3D.
...
# V (3):
- [Vectarine](https://github.com/vanyle/vectarine/) - Vectarine is a cross-platform game engine focusing on ultra fast prototyping and having fun. It uses Luau for scripting and can be extended with Rust.
...
- [Game Engine Tracker](https://gameenginetracker.com/)
